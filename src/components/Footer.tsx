...
const Footer = () => {
  return (
    <footer className="bottom-0 left-0 w-full bg-gradient-to-r from-amber-500 to-red-600 py-4 z-50 relative overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between text-white">
          ...
          <div className="flex flex-col sm:flex-row items-center flex-1 px-4 min-w-0">
            ...
            <div className="flex gap-4 sm:gap-6 shrink-0 text-sm font-light mb-2 sm:mb-0">
              <a
                href="https://github.com/TalhaJawaid143"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/talha-jawaid-3689952b6/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                ...
                href="https://www.instagram.com/talha_sheikh_601/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 text-white/70 hover:text-white transition-colors"
              >
              ...
              <a
                href="mailto:talhajawaid601@gmail.com.com"
                className="p-2 text-white/70 hover:text-white transition-colors relative"
              >
