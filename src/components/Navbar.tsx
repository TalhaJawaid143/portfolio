  ...
  return (
    <motion.header
      ...
      className={`fixed inset-x-0 top-0 z-50 ${
        scrolled ? "bg-[#0f0a07]/90 backdrop-blur-md" : "bg-transparent backdrop-blur-sm"
      }`}
    >
      <nav className="flex items-center justify-between p-3 lg:px-6 max-w-[1440px] mx-auto">
        {/* Logo (removed the logo image part) */}
        <motion.div
        ...
        >
          <button
            ...
            aria-label="Home"
          >
            {/* Optional: Add a placeholder text or icon here if needed */}
            <span className="text-black ">MySite</span>
          </button>
        </motion.div>
        ...
        <motion.div
          ...
          className="hidden lg:flex absolute left-1/2 transform -translate-x-1/2 gap-3 rounded-full bg-gradient-to-r from-amber-500 to-red-600 px-4 py-1 text-white lg:items-center lg:gap-x-8"
        >
          {NAV_ITEMS.map((item) => {
            const sectionId = item.href.substring(1);
            return (
        ...
        <Transition.Root show={mobileMenuOpen} as={Fragment}>
          <Dialog as="div" className="relative z-50 lg:hidden" onClose={setMobileMenuOpen}>
            <Transition.Child
              ...
              leaveTo="opacity-0"
            >
              <div className="fixed inset-0 bg-[#0f0a07]/80 backdrop-blur-sm" />
            </Transition.Child>
            ...
            <div className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto">
              ...
              >
                <Dialog.Panel className="relative h-full w-full bg-[#1a120b]/90 backdrop-blur-lg px-6 py-6 sm:max-w-sm">
                  ...
                  <div className="mt-6 flow-root">
                    <div className="-my-6 divide-y divide-amber-900/30">
